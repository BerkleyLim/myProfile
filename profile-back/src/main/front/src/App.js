    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/career-form/:cno" element={<CareerFormComponent isLogin={isLogin} />} />
          <Route path="/skill-form/:category/:no/:rootNo" element={<SkillFormComponent isLogin={isLogin} />} />
          <Route path="/project" element={<ProjectComponent isLogin={isLogin}/>} />
          <Route path="/project" element={<ProjectComponentSample isLogin={isLogin}/>} />
