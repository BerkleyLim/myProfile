            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <div className="row card-text">
                  <p className="col-md-2">사용기술 : </p>
                  <CustomArea className="col-md-10" defaultValue={project.skills} />
                </div>
                <p className="card-text">프로젝트 인원 : <CustomInput defaultValue={project.people} /></p>
                <div className="row card-text">
                  <p className="col-md-2">프로젝트 설명 : </p>
                  <CustomArea className="col-md-10" defaultValue={project.detail} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text" style={{whiteSpace:"pre-write"}}>사용기술 : {project.skills}</p>
                <p className="card-text">프로젝트 인원 : {project.people}</p>
                <p className="card-text" style={{whiteSpace:"pre-write"}}>프로젝트 설명 : {project.detail} </p>
              </div>
            </div>
          </div>
        </div>
